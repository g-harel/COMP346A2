...
class BlockStack
{
	...
	/**
	 * Variable to track the amount of times stack is accessed
	 */
	...
	/**
	 * returns number of times stack is accessed
	...
	/**
	 * returns a boolean that determines if stack is empty
	 * @return a boolean that determines if stack is empty
	 */
